...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (lines.Length == 0)
            {
                logger.LogError("No lines in csv file");
                
            }

            if (lines.Length == 1)
            {
                logger.LogWarning("Only 1 line in csv file");
            }
            ...
            ITrackable startPoint = null;
            ITrackable endPoint = null;
            ...
            logger.LogInfo($"The 2 furthest taco bells are {startPoint.Name} at {startPoint.Location.Latitude}, {startPoint.Location.Longitude} and {endPoint.Name} at {endPoint.Location.Latitude}, {endPoint.Location.Longitude}. The distance between the stores is {furthestDistance} meters.");
